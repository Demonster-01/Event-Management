...
from .serializer import VenueSerializer, ServiceSerializer
...
class ServiceView(APIView):
    def get(self, request, format=None):
        Service = Service.objects.all()  # Fetch all Venue records
        serializer = ServiceSerializer(Service, many=True)  # Serialize the data
        return Response(serializer.data)  # Return the data as a JSON response
