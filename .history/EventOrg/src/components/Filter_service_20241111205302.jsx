          ...
          <div className={styles.range}>
            ...
            <ReactSlider
              ...
              renderThumb={(props, state) => (
                <div
                className={`${styles.trackFilled} ${state.index === 1 ? styles.trackFilledLeft : styles.trackFilledRight}`}
                style={{ width: `${(state.valueNow[1] - state.valueNow[0]) / (state.max - state.min) * 100}%` }}
              />
            </div>
              )}
            />
